        ...
        <div class="box-body">
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('record_per_page') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="record_per_page">No. of record per page &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Set number of record shown in one page"></i>
                                </label>
                                <input type="text" class="form-control" id="record_per_page" name="record_per_page" value="<?=set_value('record_per_page', $setting->record_per_page)?>" >
                                <span class="control-label">
                                    <?=form_error('record_per_page'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <fieldset class="setting-fieldset hide">
            ...
            <fieldset class="setting-fieldset">
                <legend class="setting-legend">Invoice/Voucher Setting</legend>
                <div class="row"> 


                    
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('voucher_notes') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="voucher_notes">Voucher Notes &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="This will be shown on voucher"></i>
                                </label>
                                <textarea class="form-control" id="voucher_notes" name="voucher_notes" ><?=set_value('voucher_notes', $setting->voucher_notes)?></textarea>
                                <span class="control-label">
                                    <?=form_error('voucher_notes'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('bank_account') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="bank_account">Invoice Bank Account &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Invoice bank account will be print on challan"></i>
                                </label>
                                <input type="text" class="form-control" id="bank_account" name="bank_account" value="<?=set_value('bank_account', $setting->bank_account)?>" >
                                <span class="control-label">
                                    <?=form_error('bank_account'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('transaction_title') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="transaction_title">Voucher Transaction Title &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="This will be shown on voucher for API reference"></i>
                                </label>
                                <input type="text" class="form-control" id="transaction_title" name="transaction_title" value="<?=set_value('transaction_title', $setting->transaction_title)?>" >
                                <span class="control-label">
                                    <?=form_error('transaction_title'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('company_code') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="company_code">Voucher Company Code &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="This will be shown on voucher for API reference and search "></i>
                                </label>
                                <input type="text" class="form-control" id="company_code" name="company_code" value="<?=set_value('company_code', $setting->company_code)?>" >
                                <span class="control-label">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('invoice_date') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="invoice_date">Invoice Due Date &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Invoice due date will be printed on challan if empty challan will printed according to invoice due date"></i>
                                </label>
                                <input type="text" class="form-control datepicker" id="invoice_date" name="invoice_date" value="<?=set_value('invoice_date', $setting->invoice_date)?>" >
                                <span class="control-label">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('book_fine') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="currency_symbol">Book Fine Per Day &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Set per day fine for late return of books"></i>
                                </label>
                                <input type="text" class="form-control" id="book_fine" name="book_fine" value="<?=set_value('book_fine', $setting->book_fine)?>" >
                                <span class="control-label">
                                    <?=form_error('book_fine'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group <?=form_error('voucher_email') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="voucher_email">Voucher Email &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Set per day fine for late return of books"></i>
                                </label>
                                <input type="text" class="form-control" id="voucher_email" name="voucher_email" value="<?=set_value('voucher_email', $setting->voucher_email)?>" >
                                <span class="control-label">
                                    <?=form_error('voucher_email'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('discount_feetypesID') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Discount Fee Type <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Discount Fee Type"></i>
                                </label>
                                    <?php
                                        ...
                                        echo form_dropdown("discount_feetypesID", $feetype_Array, set_value("discount_feetypesID", $setting->discount_feetypesID), "id='discount_feetypesID' class='form-control select2'");
                                    ?>
                                <span class="control-label">
                                    <?=form_error('discount_feetypesID'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('transaction_charges') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="currency_symbol">Transaction Charges &nbsp;<i class="fa fa-question-circle" ></i>
                                </label>
                                <input type="text" class="form-control" id="transaction_charges" name="transaction_charges" value="<?=set_value('transaction_charges', $setting->transaction_charges)?>" >
                                <span class="control-label">
                                    <?=form_error('transaction_charges'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('maximum_cap_days_fine') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="currency_symbol">Maximum Cap Days Fine &nbsp;<i class="fa fa-question-circle"  ></i>
                                </label>
                                <input type="text" class="form-control" id="maximum_cap_days_fine" name="maximum_cap_days_fine" value="<?=set_value('maximum_cap_days_fine', $setting->maximum_cap_days_fine)?>" >
                                <span class="control-label">
                                    <?=form_error('maximum_cap_days_fine'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('is_cron_active') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Is Cron Active <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Discount Fee Type"></i>
                                </label>
                                    <?php
                                        $is_cron_active_Array[''] = 'Please Select';
                                        $is_cron_active_Array['1'] = 'Enable';
                                        $is_cron_active_Array['0'] = 'Disable';
                                         
                                        echo form_dropdown("is_cron_active", $is_cron_active_Array, set_value("is_cron_active", $setting->is_cron_active), "id='is_cron_active' class='form-control select2'");
                                    ?>
                                <span class="control-label">
                                    <?=form_error('is_cron_active'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('enrolment_feetype') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Enrollment Fee Type <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Discount Fee Type"></i>
                                </label>
                                    <?php
                                        $feetype_Array['0'] = 'Please Select';
                                        if(customCompute($feetypes)) {
                                        ...
                                        echo form_dropdown("enrolment_feetype", $feetype_Array, set_value("enrolment_feetype", $setting->enrolment_feetype), "id='enrolment_feetype' class='form-control select2'");
                                    ?>
                                <span class="control-label">
                                    <?=form_error('enrolment_feetype'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('discount_credit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Discount Credit Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Discount Fee Type"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("discount_credit", $chofaccArray, set_value("discount_credit", $setting->discount_credit), "id='discount_credit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('discount_credit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('discount_debit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Discount Debit Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Discount Fee Type"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("discount_debit", $chofaccArray, set_value("discount_debit", $setting->discount_debit), "id='credit_id' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('discount_debit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('student_cr_account') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Payment Credit Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Payment Credit Account"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("student_cr_account", $chofaccArray, set_value("student_cr_account", $setting->student_cr_account), "id='credit_id' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('student_cr_account'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <fieldset class="setting-fieldset">
                <legend class="setting-legend">Supply Chain</legend>
                
                     <div class="col-sm-3">
                        <div class="form-group <?=form_error('asset_purchase_credit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Asset Purchase  Credit Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Asset Purchase Chart of Account"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("asset_purchase_credit", $chofaccArray, set_value("asset_purchase_credit", $setting->asset_purchase_credit), "id='asset_purchase_credit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('asset_purchase_credit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('asset_purchase_debit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Asset Purchase Debit Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Asset Purchase Chart of Account"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("asset_purchase_debit", $chofaccArray, set_value("asset_purchase_debit", $setting->asset_purchase_debit), "id='asset_purchase_debit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('asset_purchase_debit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group <?=form_error('inventory_purchase_credit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Inventory Purchase  Credit Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Inventory Purchase Chart of Account"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("inventory_purchase_credit", $chofaccArray, set_value("inventory_purchase_credit", $setting->inventory_purchase_credit), "id='invertory_purchase_credit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('inventory_purchase_credit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('inventory_purchase_debit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Inventory Purchase Debit Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Inventory Purchase Chart of Account"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("inventory_purchase_debit", $chofaccArray, set_value("inventory_purchase_debit", $setting->inventory_purchase_debit), "id='inventory_purchase_debit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('inventory_purchase_debit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group <?=form_error('tax_debit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Tax Debit <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Tax Debit"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("tax_debit", $chofaccArray, set_value("tax_debit", $setting->tax_debit), "id='invertory_purchase_credit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('tax_debit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('tax_credit') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Tax Credit<span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Tax Credit"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("tax_credit", $chofaccArray, set_value("tax_credit", $setting->tax_credit), "id='tax_credit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('tax_credit'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <fieldset class="setting-fieldset">
                <legend class="setting-legend">Chart of Account Setting</legend>
                
                     <div class="col-sm-3">
                        <div class="form-group <?=form_error('vender_account') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Vender Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Vender Account "></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("vender_account", $chofaccArray, set_value("vender_account", $setting->vender_account), "id='vender_account' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('vender_account'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('student_account') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Student Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Student Account "></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("student_account", $chofaccArray, set_value("student_account", $setting->student_account), "id='student_account' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('student_account'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group <?=form_error('supplier_account') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Supplier Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Supplier Account"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("supplier_account", $chofaccArray, set_value("supplier_account", $setting->supplier_account), "id='invertory_purchase_credit' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('supplier_account'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group <?=form_error('employee_account') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class">Employee Account <span class="text-red">*</span> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Default Employee Account"></i>
                                </label>
                                    <?php
                                ...
                                echo form_dropdown("employee_account", $chofaccArray, set_value("employee_account", $setting->employee_account), "id='employee_account' class='form-control select2'");
                            ?>
                                <span class="control-label">
                                    <?=form_error('employee_account'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <fieldset class="setting-fieldset">
                <legend class="setting-legend">Attendance Setting</legend>
                        ...
                        <div class="col-sm-4"> 
                            <div class="form-group <?=form_error('attendance_fine_feetypeID') ? 'has-error' : ''?>" >
                                <div class="col-sm-12">
                                    <label for="attendance_fine_feetypeID"><?=lang('attendance_fine_feetypeID')?>
                                        &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Attendance Feetype "></i>
                                    </label>
                                     <?php
                                        $feetype_Array['0'] = 'Please Select';
                                        if(customCompute($feetypes)) {
                                        ...
                                        echo form_dropdown("attendance_fine_feetypeID", $feetype_Array, set_value("attendance_fine_feetypeID", $setting->attendance_fine_feetypeID), "id='attendance_fine_feetypeID' class='form-control select2'");
                                    ?>
                                    <span class="control-label"><?=form_error('attendance_fine_feetypeID'); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        <div class="form-group <?php if(form_error('attendancestatus')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                            <label>Student Status&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Select Status"></i></label>
                                <?php
                                    $array = get_student_status_type();

                                    if(isset($setting->attendancestatus)) {
                                        $expattendancestatus = explode(',', $setting->attendancestatus);
                                    } else {
                                        $expattendancestatus = [];
                                    }

                                    echo form_multiselect("attendancestatus[]", $array, set_value('attendancestatus', $expattendancestatus), "id='attendancestatus' class='form-control'");
                                ?>
                                <span class="control-label">
                                    <?php echo form_error('attendancestatus[]'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
