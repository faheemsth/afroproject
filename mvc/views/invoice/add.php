<div class="row">
                    ...
                    <div class=" form-group <?= form_error('Decision') ? 'has-error' : '' ?>">
                        ...
                        <div class="col-sm-4 col-xs-4 col-md-6">
                            <div class="fileUpload btn btn-success form-control">
                                ...
                                <input id="uploadBtn" type="file" class="upload" name="csvFile" data-show-upload="false" data-show-preview="false" required="required" />
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
    ...
    <div class="col-sm-5" id="late_payment_fine" style="display: none;">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><i class="fa icon-invoice"></i> <?= 'Late Fee Fine' ?></h3>
            </div><!-- /.box-header -->
            <div class="box-body">

                <div class="installment_Div form-group <?= form_error('late_fee_fine') ? 'has-error' : '' ?>">
                    <label for="date">
                        Installments <span class="text-red">*</span>
                    </label>
                    <?php 
                    ...
                    echo form_dropdown("installment", $installment_arr, set_value("0"), "id='installment' class='form-control select2'");
                    ?>
                </div>


                <div class="installmentDeadline form-group <?= form_error('installment_deadline') ? 'has-error' : '' ?>">
                    <label for="date">
                        Installment Deadline <span class="text-red">*</span>
                    </label>
                    <input type="text" class="form-control date" id="installment_deadline" name="installment_deadline" value="<?= set_value('installment_deadline') ?>">
                    <span class="text-red">
                        <?php echo form_error('installment_deadline'); ?>
                    </span>
                </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#addInvoiceButton', function() {
        ...
        var fields = {
            ...
            'installment_deadline': $('#installment_deadline').val()
        };
        ...
        if (field['remarks'] === '') {
            ...
            $('.remarksDiv').removeClass('has-error');
        }
