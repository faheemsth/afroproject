            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group <?=form_error('productsupplier_strn') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplier_strn" name="productsupplier_strn" value="<?=set_value('productsupplier_strn', $productsupplier->productsupplier_strn)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productsupplier_ntn') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplier_ntn" name="productsupplier_ntn" value="<?=set_value('productsupplier_ntn', $productsupplier->productsupplier_ntn)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productsupplier_bank') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplier_bank" name="productsupplier_bank" value="<?=set_value('productsupplier_bank', $productsupplier->productsupplier_bank)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productsupplier_branch_code') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplier_branch_code" name="productsupplier_branch_code" value="<?=set_value('productsupplier_branch_code', $productsupplier->productsupplier_branch_code)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productsupplier_account_title') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplier_account_title" name="productsupplier_account_title" value="<?=set_value('productsupplier_account_title', $productsupplier->productsupplier_account_title)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productsupplier_account_number') ? 'has-error' : '' ?>" >
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplier_account_number" name="productsupplier_account_number" value="<?=set_value('productsupplier_account_number', $productsupplier->productsupplier_account_number)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('productsupplier_quotation') ? 'has-error' : '' ?>" >
                        <label for="productsupplier_quotation" class="col-sm-2 control-label">
                            Quotation
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="productsupplier_quotation" name="productsupplier_quotation" value="<?=set_value('productsupplier_quotation', $productsupplier->supplier_quotation)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('productsupplier_quotation'); ?>
                        </span>
                    </div>
