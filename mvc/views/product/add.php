        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group <?=form_error('code_reference') ? 'has-error' : '' ?>" >
                        <label for="code_reference" class="col-sm-2 control-label">
                            Product Code/Ref. <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="code_reference" name="code_reference" value="<?=set_value('code_reference')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('code_reference'); ?>
                        </span>
                    </div>
