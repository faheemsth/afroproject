<?php if(customCompute($profile)) {
 ?>
	<div class="well">
	    <div class="row">
	        <div class="col-sm-6">
	            ...
	            <?php if($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) { if(permissionChecker('student_edit')) { 
	            	echo btn_sm_edit('student/edit/'.$profile->srstudentID."/".$set, $this->lang->line('edit')); 
	            	echo btn_sm_edit('student/update_status/'.$profile->srstudentID."/".$set, 'Update Status'); 
	            	echo btn_sm_edit('student/student_ledger/'.$profile->srstudentID."/".$set, 'Student Ledger'); 
		        ...
		        <div class="nav-tabs-custom">
		            <ul class="nav nav-tabs">
		              	...
		              	<?php if((permissionChecker('student_add') && permissionChecker('student_delete')) || ($this->session->userdata('usertypeID') == $profile->usertypeID && $this->session->userdata('loginuserID') == $profile->srstudentID)) {  ?>
			              	...
			              	<li><a href="#fee" data-toggle="tab"><?=$this->lang->line('student_fee')?></a></li>
			              	<li><a href="#concession" data-toggle="tab"><?=$this->lang->line('student_concession')?></a></li>
		              		...
		              		<li><a href="#status_history" data-toggle="tab">Status History</a></li>
		              	<?php } ?>
		            </ul>
		            ...
		            <div class="tab-content">
			            ...
			            <?php if((permissionChecker('student_add') && permissionChecker('student_delete')) || ($this->session->userdata('usertypeID') == $profile->usertypeID && $this->session->userdata('loginuserID') == $profile->srstudentID)) {  ?>
                        	...
                        	<div class="tab-pane" id="fee">
			              	...
			              	<div class="tab-pane" id="concession">
			              		<div class="panel-body">
			              			<form class="form-horizontal" role="form" method="post" action="<?=base_url('student/concession_fee');?>" enctype="multipart/form-data">
					            	<div class="row">
					            		...
					            		<div class="col-sm-12 form-group">
					            			...
					            			<div class="col-sm-2">
					            				<?=$profile->discount?>
					            				<input type="hidden" name="std_ol_discount" id="std_ol_discount" value="<?=$profile->discount?>">
					            			</div>
					            			<div class="col-sm-2">
					            				+
					            			</div>
					            			<div class="col-sm-6">
					            				<input type="text" class="form-control" id="totaldiscount" required name="totaldiscount" value="">
					            			</div>
					            		</div>
					            		...
					            		<div class="col-sm-12 form-group">
					            			...
					            			<div class="col-sm-6">
					            				<input type="text" name="decision_title" id="decision_title" required class="form-control">
					            			</div>
					            		</div>
					            		<div class="col-sm-12">
					            			<div class="col-sm-12 form-group">
						            			<?php
							                        if(form_error('decision_upload'))
							                            echo "<div class='form-group decision_upload_sec has-error' >";
							                        else
							                            echo "<div class='form-group decision_upload_sec' >";
							                    ?>
							                        <label for="photo" class="col-sm-2 control-label">
							                            <?=$this->lang->line("decision_photo")?>
							                        </label>
							                        <div class="col-sm-6">
							                            <div class="input-group image-preview">
							                                ...
							                                <span class="input-group-btn">
							                                    <button type="button" class="btn btn-default image-preview-clear" style="display:none;">
							                                        ...
							                                        <?=$this->lang->line('decision_clear')?>
							                                    </button>
							                                    <div class="btn btn-success image-preview-input">
							                                        <span class="fa fa-repeat"></span>
							                                        <span class="image-preview-input-title">
							                                        <?=$this->lang->line('decision_file_browse')?></span>
							                                        <input type="file" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain,image/png, image/jpeg, image/gif" required name="file"/>
							                                    </div>
							                                </span>
							                            </div>
							                        </div>
							                        ...
							                        <span class="col-sm-4">
							                            <?php echo form_error('decision_upload'); ?>
							                        </span>
							                    </div>
					            			</div>
					            		</div>
			              	...
			              	<div class="tab-pane" id="invoice">
			              		<div id="hide-table" style="overflow:auto;">
				                     ...
				                     <table class="table table-striped table-bordered table-hover">
				                        ...
				                        <tbody>
						              		...
						              		// print_r($invoices);
						              		// echo '</pre>';
						              		$totalInvoice = 0; $totalDiscount = 0; $totalPaid = 0; $totalWeaver = 0; $totalDue = 0; $totalFine = 0; if(customCompute($invoices)) { $i = 1; foreach ($invoices as $invoice) { ?>
						              			<tr>
				                                    <td data-title="<?=$this->lang->line('slno')?>">
				                                        <?php echo $i; ?>
				                                    </td>
				                                    <td data-title = "<?=$this->lang->line('refrence_no')?>">
				                                    ...
				                                    <td data-title="<?=$this->lang->line('student_discount')?>">
				                                    	<?php
				                                    	 ...
				                                    	 ?>
				                                        <?php $discountAmount = 0; if($invoice->discount > 0) { $discountAmount = $invoice->discount; } echo number_format($discountAmount, 2); $totalDiscount += $discountAmount; ?>
				                                    </td>
			              			...
			              			<table class="table table-striped table-bordered table-hover">
			              				...
			              				<tbody>
			              						<?php
			              							...
			              							// print_r($payments);
			              							// echo '</pre>';
			              							$total_semester = $profile->balance + $profile->net_fee;
			              						?>
			              						<tr>
			              							<td>Opening</td>
			              							<td></td>
			              						...
			              						<tr>
			              							<td><b><?=$this->lang->line('student_section')?></b> <?=customCompute($section) ? $section->section : ''?></td>
			              							<td></td>
			              							<td>Fee Charged</td>
			              							<td><?php echo $profile->net_fee; ?></td>
			              						...
			              						<?php $totalPaymentPaid = 0; $totalPaymentWeaver = 0; $totalPaymentFine = 0; if(customCompute($payments)) { $i = 1; foreach ($payments as $payment) {
			              							// echo $payments->sectionID;
			              								if ($payment->sectionID == $profile->sectionID) {
			              						  ?>
						              			<tr>
						              				<td data-title="<?=$this->lang->line('student_date')?>">
				                                    ...
				                                    <td data-title="<?=$this->lang->line('student_weaver')?>">
				                                        <?php
				                                        	$total_semester = $total_semester - $paymentpaidAmount;
				                                        	echo ceil($total_semester);
				                                        ?>
				                                    </td>
				                                </tr>
						              		<?php $i++; } } } ?>
			              						...
			              						<?php
			              							// $totalInvoice = 0; $totalDiscount = 0; $totalPaid = 0; $totalWeaver = 0; $totalDue = 0; $totalFine = 0;
			              							// foreach ($invoices as $invoice){
			              								?>
			              								<!-- <tr>
			              									<td><?=!empty($invoice->date) ? date('d M Y', strtotime($invoice->date)) : ''?></td>
			              									<td><?php echo $invoice->refrence_no; ?></td>
			              									<td>Fee</td>
			              									<td><?php $paymentAmount = 0; if(isset($allpaymentbyinvoice[$invoice->invoiceID])) { $paymentAmount = $allpaymentbyinvoice[$invoice->invoiceID]; } echo number_format($paymentAmount, 2); $totalPaid += $paymentAmount; ?></td>
			              									<td>0</td>
			              								</tr>	 -->
			              								<?php
			              							// }
			              	...
			              	<div class="tab-pane" id="status_history">
			              		...
			              		<div id="hide-table">
				                    <table class="table table-striped table-bordered table-hover">
				                        ...
				                        <tbody>
						              		<?php 
						              		$all_status =	get_student_status_type();
						              		if(customCompute($allhistory)) { $i = 1; foreach ($allhistory as $h) { 

						              			$st_array 	= unserialize($h->meta_value);
						              		 ?>
						              			<tr>
				                                    <td data-title="<?=$this->lang->line('slno')?>">
				                                        <?php echo $i;    ?>
				                                    ...
				                                    <td data-title="<?=$this->lang->line('action')?>">
				                                        <?php  
				                                        	 echo date('d-m-Y' , strtotime($h->created));
				                                        ?>
				                                    </td>

				                                    <td data-title="<?=$this->lang->line('student_title')?>">
				                                        <?=$all_status[$st_array['status']]?>
				                                    </td>
	    ...
	    $('#totaldiscount').keyup(function() {
		     ...
		     if(discount != '' && totalfee != ''){
		        if(discount_type == 'percentage'){
		            ...
		            var total = totalfee;
		            var totals = discount + std_ol_discount;
		            console.log(totals);
		            var netfee = totalfee - totals;
		            var totalshtml = `<label class="col-sm-2">Net Fee</label><div class="col-sm-6">`+netfee+`</div>`;
		         }     
	...
	<script type="text/javascript" src="<?php echo base_url('assets/custom/student_getView.js'); ?>"></script>
<?php } ?>
