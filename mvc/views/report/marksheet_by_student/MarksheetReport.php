<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
        $pdf_preview_uri = base_url('marksheetreport_by_student/pdf/' . $examID . '/' . $classesID . '/' . $sectionID .'/'.$studentID);
        $xl_preview_uri = base_url('marksheetreport_by_student/xlsx/' . $examID . '/' . $classesID . '/' . $sectionID.'/'.$studentID);
        ...
        echo btn_pdfPreviewReport('marksheetreport', $xl_preview_uri, $this->lang->line('report_xlsx'));
