                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="<?php echo form_error('date') ? 'form-group has-error' : 'form-group'; ?>">
                                            ...
                                            <?php if ((isset($siteinfos->old_attendance_permission) && $siteinfos->old_attendance_permission == 'yes')) {
                                                $disable = '';
                                              
                                            } else {
                                                $disable = 'disabled';
                                                ?>
                                                     <input type="hidden" class="form-control date" name="date" value="<?= set_value("date", $date) ?>">
                                                <?php
                                            } ?>
                                            <input type="text" class="form-control date" name="date" id="date" value="<?= set_value("date", $date) ?>" <?php echo $disable ?>>
                                        </div>
                                    </div>

                                    <!-- <div class="col-md-3">
                                        <label for="">Attendance Setting</label>
                                        <select name="attendance_setting" id="" class="form form-control select2 attendance_setting">
                                            <option value="not_allow_to_old_attendance">Not Allow to old Attendance</option>
                                            <option value="allow_to_old_attendance">Allow to old Attendance</option>
                                        </select>
                                    </div> -->
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    // $(".attendance_setting").change(function(){
    //    var value = $(this).val();


    //    if(value == 'allow_to_old_attendance'){
