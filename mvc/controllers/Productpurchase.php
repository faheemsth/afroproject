    ...
    */
    ...
    public function index()
    {
        ...
        if (isset($_GET)) {
            ...
            if (isset($_GET['productcategoryID']) && !empty($_GET['productcategoryID'])) {
                ...
                $filter['productcategory.productcategoryID'] = $_GET['productcategoryID'];
            } else {
    ...
    public function view()
    {
        ...
        if ((int)$id) {
            ...
            $this->data['createuser']  = getObjectByUserTypeIDAndUserID($this->data['productpurchase']->create_usertypeID, $this->data['productpurchase']->create_userID);
            $this->data['fromuser']     = getObjectByUserTypeIDAndUserID($this->data['productpurchase']->create_usertypeID, $this->data['productpurchase']->create_userID);
            $this->data['approve_one']  = getObjectByUserTypeIDAndUserID($this->data['productpurchase']->firstAprove_usertypeID, $this->data['productpurchase']->firstAprove_userID);
            $this->data['approve_two']  = getObjectByUserTypeIDAndUserID($this->data['productpurchase']->secondAprove_usertypeID, $this->data['productpurchase']->secondAprove_userID);
