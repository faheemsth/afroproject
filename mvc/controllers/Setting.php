...
*/
    ...
    protected function rules()
    {
        $rules = [
            ...
            [
                'field' => 'book_fine',
                'label' => $this->lang->line("book_fine"),
                'rules' => 'trim|required|max_length[3]|xss_clean'
            ],
            [
                'field' => 'record_per_page',
            ...
            [
                ...
                'label' => 'Account title/slug shown on voucer',
            ...
            [
                'field' => 'discount_feetypesID',
                'label' => 'Discount Fee Type',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'company_code',
                'label' => 'Voucher Company Code',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'bank_account',
            ...
            [
                'field' => 'voucher_email',
                'label' => 'Invoice/Voucher Email',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'discount_credit',
                'label' => 'Discount Credit Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'discount_debit',
                'label' => 'Discount Debit Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'student_cr_account',
            ...
            [
                'field' => 'asset_purchase_credit',
                'label' => 'Asset Purchase Credit Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'asset_purchase_debit',
                'label' => 'Asset Purchase Debit Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'inventory_purchase_credit',
                'label' => 'Inventory Purchase Credit Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'inventory_purchase_debit',
                'label' => 'Inventory Purchase Debit Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'tax_credit',
            ...
            [
                ...
                'label' => 'Vender chart Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'student_account',
                'label' => 'Student chart Account',
                'rules' => 'trim|required|xss_clean'
            ],
            [
            ...
            [
                'field' => 'enrolment_feetype',
                'label' => 'Enrollment Fee Type',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'attendance_fine_percentage',
                'label' => 'Attendance Fine Percentage',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'attendance_per_percantage_fine',
                'label' => 'Attendance Per Day Fine',
                'rules' => 'trim|required|xss_clean'
            ],
            [
            ...
            [
                'field' => 'maximum_cap_days_fine',
                'label' => 'Maximum Cap Days Fine',
                'rules' => 'trim|required|xss_clean'
            ],
            [
                'field' => 'is_cron_active',
                'label' => 'Is Cron Active',
                'rules' => 'trim|required|xss_clean'
            ]
        ];
        ...
        if ( $this->data['setting'] ) {
            if ( $_POST ) {
                ...
                if ( $this->form_validation->run() == false ) {
                    ...
                    if ( $this->input->post('attendancestatus') ) {
                        $attendancestatusArray     = $this->input->post('attendancestatus');
                        $attendancests          = implode(',', $attendancestatusArray);
                        $array['attendancestatus'] = $attendancests;
                        unset($array['attendancestatus[]']);
                    } else {
                        unset($array['attendancestatus[]']);
