        ...
        if($_POST) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $array = array(
                    ...
                    "vendor_strn"               => $this->input->post("vendor_strn"),
                    "vendor_ntn"                => $this->input->post("vendor_ntn"),
                    "vendor_bank"               => $this->input->post("vendor_bank"),
                    "vendor_branch_code"        => $this->input->post("vendor_branch_code"),
                    "vendor_account_title"      => $this->input->post("vendor_account_title"),
